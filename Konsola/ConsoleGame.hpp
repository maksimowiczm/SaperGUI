...
namespace konsola
{
	...
	private:
		 ...
		 */
		std::vector<std::tuple<ConsoleMenu::controls, std::vector<int>>> controls_;
	...
	public:
		ConsoleGame(int16_t Xsize, int16_t Ysize, int16_t mines, COORD leftUpperCorner, std::vector<std::tuple<ConsoleMenu::controls, std::vector<int>>> controls);
